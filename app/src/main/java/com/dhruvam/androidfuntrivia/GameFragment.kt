...
import com.dhruvam.androidfuntrivia.databinding.FragmentGameBinding
...
class GameFragment : Fragment() {
    ...
    private fun setQuestion() {
        ...
        // and shuffle them
        answers.shuffle()
        (activity)?.actionBar?.title = getString(R.string.title_android_trivia_question, questionIndex + 1, numQuestions)
    }
